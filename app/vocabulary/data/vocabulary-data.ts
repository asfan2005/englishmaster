import { TopicGroup, VocabularySet, VocabularyCategory } from "./types";
...
export const vocabularySets: VocabularySet[] = [
  // Everyday
  {
    ...
    category: "everyday",
    words: everydayWords.filter(word => word.level === "beginner").slice(0, 5)
  },
  {
    ...
    topicId: "daily-routines",
    category: "everyday",
    words: everydayWords.filter(word => word.level === "intermediate").slice(0, 5)
  },
  {
    ...
    topicId: "daily-routines",
    category: "everyday",
    words: everydayWords.filter(word => word.level === "advanced").slice(0, 5)
  },
  {
    ...
    category: "everyday",
    words: everydayWords.filter(word => word.topicId === "food-and-dining")
  },
  {
    ...
    category: "everyday",
    words: everydayWords.filter(word => word.topicId === "travel-and-transportation")
  },
  ...
  // Academic
  {
    ...
    topicId: "education",
    category: "academic",
    words: academicWords.filter(word => word.level === "beginner").slice(0, 5)
  },
  {
    ...
    topicId: "education",
    category: "academic",
    words: academicWords.filter(word => word.level === "intermediate").slice(0, 5)
  },
  {
    ...
    topicId: "education",
    category: "academic",
    words: academicWords.filter(word => word.level === "advanced").slice(0, 5)
  },
  {
    ...
    topicId: "research",
    category: "academic",
    words: academicWords.filter(word => word.topicId === "research")
  },
  {
    ...
    category: "academic",
    words: academicWords.filter(word => word.topicId === "critical-thinking")
  },
  ...
  // Business
  {
    ...
    topicId: "management",
    category: "business",
    words: businessWords.filter(word => word.level === "beginner").slice(0, 5)
  },
  {
    ...
    topicId: "management",
    category: "business",
    words: businessWords.filter(word => word.level === "intermediate").slice(0, 5)
  },
  {
    ...
    topicId: "management",
    category: "business",
    words: businessWords.filter(word => word.level === "advanced").slice(0, 5)
  },
  {
    ...
    topicId: "marketing",
    category: "business",
    words: businessWords.filter(word => word.topicId === "marketing")
  },
  {
    ...
    topicId: "finance",
    category: "business",
    words: businessWords.filter(word => word.topicId === "finance")
  },
  ...
  // Technology
  {
    ...
    topicId: "computing",
    category: "technology",
    words: technologyWords.filter(word => word.level === "beginner").slice(0, 5)
  },
  {
    ...
    topicId: "computing",
    category: "technology",
    words: technologyWords.filter(word => word.level === "intermediate").slice(0, 5)
  },
  {
    ...
    topicId: "computing",
    category: "technology",
    words: technologyWords.filter(word => word.level === "advanced").slice(0, 5)
  },
  {
    ...
    category: "technology",
    words: technologyWords.filter(word => word.topicId === "mobile-technology")
  },
  {
    id: "ai-vocabulary",
    title: "Artificial Intelligence",
    ...
    category: "technology",
    words: technologyWords.filter(word => word.topicId === "artificial-intelligence")
  },
  ...
  // Science
  {
    ...
    topicId: "biology",
    category: "science",
    words: scienceWords.filter(word => word.level === "beginner").slice(0, 5)
  },
  {
    ...
    topicId: "biology",
    category: "science",
    words: scienceWords.filter(word => word.level === "intermediate").slice(0, 5)
  },
  {
    id: "science-advanced",
    ...
    topicId: "physics",
    category: "science",
    words: scienceWords.filter(word => word.level === "advanced").slice(0, 5)
  },
  {
    ...
    topicId: "biology",
    category: "science",
    words: scienceWords.filter(word => word.topicId === "biology")
  },
  {
    ...
    category: "science",
    words: scienceWords.filter(word => word.topicId === "environmental-science")
  },
  ...
  // Arts
  {
    ...
    topicId: "visual-arts",
    category: "arts",
    words: artsWords.filter(word => word.level === "beginner").slice(0, 5)
  },
  {
    ...
    topicId: "visual-arts",
    category: "arts",
    words: artsWords.filter(word => word.level === "intermediate").slice(0, 5)
  },
  {
    id: "arts-advanced",
    ...
    category: "arts",
    words: artsWords.filter(word => word.level === "advanced").slice(0, 5)
  },
  {
    ...
    topicId: "visual-arts",
    category: "arts",
    words: artsWords.filter(word => word.topicId === "visual-arts")
  },
  {
    ...
    topicId: "literature",
    category: "arts",
    words: artsWords.filter(word => word.topicId === "literature")
  },
  ...
  // Social
  {
    ...
    category: "social",
    words: socialWords.filter(word => word.level === "beginner").slice(0, 5)
  },
  {
    ...
    topicId: "relationships",
    category: "social",
    words: socialWords.filter(word => word.level === "intermediate").slice(0, 5)
  },
  {
    id: "social-advanced",
    ...
    topicId: "culture",
    category: "social",
    words: socialWords.filter(word => word.level === "advanced").slice(0, 5)
  },
  {
    ...
    topicId: "relationships",
    category: "social",
    words: socialWords.filter(word => word.topicId === "relationships")
  },
  {
    ...
    category: "social",
    words: socialWords.filter(word => word.topicId === "social-media")
  }
];

// Helper function to get all words across all sets
